...
class Tello:
    ...
    def _h264_decode(self, packet_data):
        ...
        for framedata in frames:
            ...
            if frame is not None:
                ...
                frame = (frame.reshape((h, ls // 3, 3)))# 这里按照decoder的readme历程使用‘//’进行取整操作
                frame = frame[:, :w, :]
    ...
    def send_command_fast(self, command):
        """_summary_
            ...
            send command with no respond
        """
        
        # print (">> send cmd fast: {}".format(command))
    ...
    def set_rc(self,a,b,c,d):
        ...
        return self.send_command_fast('rc %s %s %s %s' % (a, b, c, d))
    
    def set_rcHeight(self,vel):
        """_summary_

            油门摇杆量
        """
        return self.set_rc(0, 0, vel, 0)
    
    def set_rcYaw(self,vel):
        """_summary_

            航向摇杆量
        """
        return self.set_rc(0, 0, 0, vel)
    
    def set_rcRoll(self,vel):
        """_summary_

            横滚摇杆量
        """
        return self.set_rc(vel, 0, 0, 0)
    
    def set_rcPitch(self,vel):
        """_summary_

            俯仰摇杆量
        """
        return self.set_rc(0, vel, 0, 0)
